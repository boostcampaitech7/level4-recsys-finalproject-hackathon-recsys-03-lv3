...
export const WebSocketProvider = ({ children }) => {
    ...
    const WS_BASE_URL = process.env.REACT_APP_BASE_URL.startsWith("https")
        ? process.env.REACT_APP_BASE_URL.replace("https", "wss")
        : process.env.REACT_APP_BASE_URL.replace("http", "ws");
